    ...
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-sans font-bold leading-tight text-navy mb-6 animate-fade-up" style={{ animationDelay: '200ms' }}>
            Catalyzing <span className="text-gold">Growth</span> & Driving <span className="text-gold">Innovation</span>
          </h1>
          
          <p className="text-lg md:text-xl text-navy-light mb-10 max-w-3xl mx-auto animate-fade-up" style={{ animationDelay: '400ms' }}>
            GrowthHall provides strategic consulting services to transform businesses in fintech, telecommunications, healthcare, and media sectors, delivering measurable results and sustainable growth.
          </p>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 animate-fade-up" style={{ animationDelay: '800ms' }}>
