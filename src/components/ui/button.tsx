...
//           "bg-destructive text-destructive-foreground hover:bg-destructive/90 active:bg-destructive/80",
//         outline:
//           "border border-input bg-background hover:bg-accent hover:text-accent-foreground active:border-gray-500",
//         secondary:
//           "bg-secondary text-secondary-foreground hover:bg-secondary/80 active:bg-secondary/70",
//         ghost:
//           "hover:bg-accent hover:text-accent-foreground active:bg-accent/70",
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95 active:bg-opacity-80 active:ring-4 active:ring-gray-300",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground active:border-gray-500",
...
//         ref={ref}
//         onClick={props.onClick ? props.onClick : () => alert("Button clicked!")}
//         {...props}
//       />
//     );
//   }
...
//           if (onClick) onClick(e); // Ensure the provided onClick function works
//         }}
//         {...props}
//       />
//     );
  ...
  ({ className, variant, size, asChild = false, onClick, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        ref={ref}
        onMouseDown={(e) => {
          e.currentTarget.classList.add("ring-4", "ring-gray-300"); // Show effect on click
        }}
        onMouseUp={(e) => {
          setTimeout(() => {
            e.currentTarget.classList.remove("ring-4", "ring-gray-300"); // Remove effect after a short delay
          }, 150);
        }}
        onClick={onClick} // Ensure normal clicks still work
        {...props}
      />
    );
  }
